...
def make_meta(data_tyoe, is_stale=False, error_count=0, 
              fetch_count=3, provider_used="yfinance"):
...
async def test_entries_have_required_fields():
    ...
    for field in ["data_type", "is_stale", "last_fetched", 
                  "age_hours", "ttl_hours", "fetch_count", 
                  "error_count", "provider_used"]:
