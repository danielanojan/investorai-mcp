...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Pre-populate the database with price history data")
    parser.add_argument("--dry-run", action="store_true", help="Run without writing to the database")
    parser.add_argument("--ticker", type=str, default=None, help="Only populate data for this ticker symbol")
    ...
    asyncio.run(main(dry_run=args.dry_run, single_ticker=args.ticker.upper() if args.ticker else None))
