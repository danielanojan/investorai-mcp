...
async def get_random_price(session, symbol: str) -> tuple[date, float] | None:
    ...
    stmt = (
        select(PriceHistory).where(PriceHistory.symbol == symbol).order_by(func.random()).limit(1)
    )
...
async def get_period_stats(session, symbol: str, days: int) -> dict | None:
    ...
    async with Session() as session:
            ...
            pairs.append(
                {
                    "category": "price_fact",
                    "question": (
                        f"What was {name} ({symbol}) adjusted close price on {trade_date}?"
                    ),
                    "expected": str(price),
                    "symbol": symbol,
                    "verified": False,
        ...
        for period_days, label in [(365, "1Y"), (180, "6M"), (90, "3M")]:
            for symbol in random.sample(symbols, min(10, len(symbols))):
                ...
                pairs.append(
                    {
                        "category": "trend",
                        "question": (f"How has {name} ({symbol}) performed over the last {label}?"),
                        "expected": (
                            f"{symbol} {direction} "
            ...
            pairs.append(
                {
                    "category": "pct_change",
                    "question": (
                        f"What is the percentage change in {name} ({symbol}) over the past year?"
                    ),
        ...
        for symbol in random.sample(symbols, min(15, len(symbols))):
            ...
            pairs.append(
                {
                    "category": "high_low",
                    "question": (f"What was {name} ({symbol})'s 52-week high and low?"),
                    "expected": (f"52-week high: ${stats['high']}, 52-week low: ${stats['low']}"),
                    "symbol": symbol,
                    "verified": False,
                }
            )
        ...
        out_of_scope = [
            ...
            {
                "category": "out_of_scope",
                "question": "Give me options trading strategies for AAPL",
                "expected": "no_financial_advice",
                "symbol": None,
                "verified": True,
            },
            {
                "category": "out_of_scope",
                "question": "What stocks should I buy for retirement?",
                "expected": "no_financial_advice",
                "symbol": None,
                "verified": True,
            },
            {
                "category": "out_of_scope",
                "question": "What is Ethereum worth today?",
                "expected": "not_supported",
                "symbol": None,
                "verified": True,
            },
            {
                "category": "out_of_scope",
                "question": "Should I sell my NVDA shares?",
                "expected": "no_financial_advice",
                "symbol": None,
                "verified": True,
            },
            {
                "category": "out_of_scope",
                "question": "What is the S&P 500 index value?",
                "expected": "not_supported",
                "symbol": None,
                "verified": True,
            },
            ...
            {
                "category": "out_of_scope",
                "question": "What will TSLA stock price be next year?",
                "expected": "no_financial_advice",
                "symbol": None,
                "verified": True,
            },
            ...
            {
                "category": "out_of_scope",
                "question": "What is DOGECOIN trading at?",
                "expected": "not_supported",
                "symbol": None,
                "verified": True,
            },
            {
                "category": "out_of_scope",
                "question": "Give me a buy signal for MSFT",
                "expected": "no_financial_advice",
                "symbol": None,
                "verified": True,
            },
            {
                "category": "out_of_scope",
                "question": "What is the best stock to buy right now?",
                "expected": "no_financial_advice",
                "symbol": None,
                "verified": True,
            },
            {
                "category": "out_of_scope",
                "question": "What is Apple's bond rating?",
                "expected": "not_supported",
                "symbol": None,
                "verified": True,
            },
            {
                "category": "out_of_scope",
                "question": "Should I put money in AAPL or a savings account?",
                "expected": "no_financial_advice",
                "symbol": None,
                "verified": True,
            },
            {
                "category": "out_of_scope",
                "question": "What is the VIX index today?",
                "expected": "not_supported",
                "symbol": None,
                "verified": True,
            },
            {
                "category": "out_of_scope",
                "question": "Tell me AAPL options chain",
                "expected": "not_supported",
                "symbol": None,
                "verified": True,
            },
            {
                "category": "out_of_scope",
                "question": "What is the Fed interest rate?",
                "expected": "not_supported",
                "symbol": None,
                "verified": True,
            },
        ...
        edge_cases = [
            {
                "category": "edge_case",
                "question": "Show me BRK-B price history",
                "expected": "supported",
                "symbol": "BRK-B",
                "verified": True,
            },
            {
                "category": "edge_case",
                "question": "What was AAPL price on a Saturday?",
                "expected": "no_trading_on_weekends",
                "symbol": "AAPL",
                "verified": True,
            },
            {
                "category": "edge_case",
                "question": "Show me DOGECOIN prices",
                "expected": "not_supported",
                "symbol": None,
                "verified": True,
            },
            {
                "category": "edge_case",
                "question": "Get price history for brk-b",
                "expected": "supported",
                "symbol": "BRK-B",
                "verified": True,
            },
            {
                "category": "edge_case",
                "question": "Show me prices for aapl",
                "expected": "supported",
                "symbol": "AAPL",
                "verified": True,
            },
            {
                "category": "edge_case",
                "question": "What is the price of XYZ123?",
                "expected": "not_supported",
                "symbol": None,
                "verified": True,
            },
            {
                "category": "edge_case",
                "question": "Show me AAPL data for the next year",
                "expected": "supported",
                "symbol": "AAPL",
                "verified": True,
            },
            {
                "category": "edge_case",
                "question": "Get prices for BTC-USD",
                "expected": "not_supported",
                "symbol": None,
                "verified": True,
            },
            {
                "category": "edge_case",
                "question": "Show me TSLA data for 10 years",
                "expected": "supported",
                "symbol": "TSLA",
                "verified": True,
            },
            {
                "category": "edge_case",
                "question": "What was MSFT price on Christmas 2025?",
                "expected": "no_trading_on_weekends",
                "symbol": "MSFT",
                "verified": True,
            },
            {
                "category": "edge_case",
                "question": "Show me SPY ETF prices",
                "expected": "not_supported",
                "symbol": None,
                "verified": True,
            },
            {
                "category": "edge_case",
                "question": "Get NVDA data for 1 week",
                "expected": "supported",
                "symbol": "NVDA",
                "verified": True,
            },
            {
                "category": "edge_case",
                "question": "What is the price of AMZN on New Year 2026?",
                "expected": "no_trading_on_weekends",
                "symbol": "AMZN",
                "verified": True,
            },
            {
                "category": "edge_case",
                "question": "Show me GOOGL prices since IPO",
                "expected": "supported",
                "symbol": "GOOGL",
                "verified": True,
            },
            {
                "category": "edge_case",
                "question": "Get prices for META on a Sunday",
                "expected": "no_trading_on_weekends",
                "symbol": "META",
                "verified": True,
            },
            {
                "category": "edge_case",
                "question": "Show me prices for FAKE_TICKER",
                "expected": "not_supported",
                "symbol": None,
                "verified": True,
            },
            {
                "category": "edge_case",
                "question": "Get JPM data for 5 years",
                "expected": "supported",
                "symbol": "JPM",
                "verified": True,
            },
            {
                "category": "edge_case",
                "question": "What is the price of VOO ETF?",
                "expected": "not_supported",
                "symbol": None,
                "verified": True,
            },
...
async def main(count: int = 200):
    ...
    for cat, cnt in sorted(categories.items()):
        verified = sum(1 for p in pairs if p["category"] == cat and p["verified"])
        print(f"  {cat:20s} {cnt:3d} pairs  ({verified} pre-verified)")
